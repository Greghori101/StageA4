...
<div class="container mt-5">
    <h1 class="mb-4">{{ __('interface.edit_session') }}</h1>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" name="name" class="form-control" 
                           value="{{ old('name', $programSession->name) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id="date" name="date" class="form-control" 
                           value="{{ old('date', $programSession->date) }}" required>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" id="start_time" name="start_time" class="form-control" 
                           value="{{ old('start_time', $programSession->start_time) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="time" id="end_time" name="end_time" class="form-control" 
                           value="{{ old('end_time', $programSession->end_time) }}" required>
                </div>
            </div>
        </div>
            ...
            <select class="form-select" id="users" name="users[]" multiple size="5">
                @foreach($users as $user)
                    <option value="{{ $user->id }}" 
                            {{ collect(old('users', $programSession->users->pluck('id')))->contains($user->id) ? 'selected' : '' }}>
                        {{ $user->full_name }}
                    </option>
                @endforeach
            </select>
